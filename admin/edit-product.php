                ...
                <div class="form-grid">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="calories" value="<?php echo $product['calories'] ?? 0; ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>الوصف (عربي)</label>
                            <textarea name="description_ar" rows="3"><?php echo htmlspecialchars($product['description_ar'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($product['image']): ?>
                                <div style="margin-bottom:8px;">
                                    <img src="../assets/images/<?php echo htmlspecialchars($product['image']); ?>" width="80" height="80" style="border-radius:8px;object-fit:cover;">
                                </div>
                            <?php endif; ?>
                            <input type="file" name="image" accept="image/*">
                            <small style="color:#6b5a4a;">اتركه فارغاً للاحتفاظ بالصورة الحالية</small>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="origin_ar" value="<?php echo htmlspecialchars($product['origin_ar'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="process_method_ar" value="<?php echo htmlspecialchars($product['process_method_ar'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>المعالجة (إنجليزي)</label>
                            <input type="text" name="process_method" value="<?php echo htmlspecialchars($product['process_method'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>التحميص (عربي)</label>
                            <input type="text" name="roast_level_ar" value="<?php echo htmlspecialchars($product['roast_level_ar'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>التحميص (إنجليزي)</label>
                            <input type="text" name="roast_level" value="<?php echo htmlspecialchars($product['roast_level'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>مستوى الكافيين (عربي)</label>
                            <input type="text" name="caffeine_level_ar" value="<?php echo htmlspecialchars($product['caffeine_level_ar'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>مستوى الكافيين (إنجليزي)</label>
                            <input type="text" name="caffeine_level" value="<?php echo htmlspecialchars($product['caffeine_level'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>الإيحاءات (عربي)</label>
                            <input type="text" name="flavor_notes_ar" value="<?php echo htmlspecialchars($product['flavor_notes_ar'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>الإيحاءات (إنجليزي)</label>
                            <input type="text" name="flavor_notes" value="<?php echo htmlspecialchars($product['flavor_notes'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group">
                            <label>المكونات (عربي)</label>
                            <textarea name="ingredients_ar" rows="2"><?php echo htmlspecialchars($product['ingredients_ar'] ?? ''); ?></textarea>
                        </div>
                        
                        <div class="form-group">
                            <label>المكونات (إنجليزي)</label>
                            <textarea name="ingredients" rows="2"><?php echo htmlspecialchars($product['ingredients'] ?? ''); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="display_order" value="<?php echo $product['display_order'] ?? 0; ?>">
                        </div>
                        ...
                        <div class="tag-inputs">
                            <?php 
                            $tagCount = max(count($tags), 3);
                            for ($i = 0; $i < $tagCount; $i++): 
                                $tag = $tags[$i] ?? null;
                            ?>
                                <div class="tag-row">
                                    <input type="text" name="tags[]" placeholder="وسم (عربي)" value="<?php echo htmlspecialchars($tag['tag_ar'] ?? ''); ?>">
                                    <input type="text" name="tags_ar[]" placeholder="وسم (إنجليزي)" value="<?php echo htmlspecialchars($tag['tag'] ?? ''); ?>">
                                </div>
                            <?php endfor; ?>
                        </div>
                    </div>
